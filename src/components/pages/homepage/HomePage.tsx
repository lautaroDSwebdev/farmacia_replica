        ...
        <DiscountPrice/>
            <article className="pt-[3rem] w-full">
                <div className="flex justify-center gap-3 max-w-maximo-ancho mx-auto">
                    <img className="h-[10rem] cursor-pointer" src="./make-up.png" alt=""/>
                    <img className="h-[10rem] cursor-pointer" src="./Perfumes.png" alt=""/>
                </div>
            </article>
        <Products1/>
            <article className="pt-[3rem] w-full">
                <div className="flex justify-center gap-3 max-w-maximo-ancho mx-auto">
                    <img className="h-[10rem] cursor-pointer" src="./Maternidad-y-bebe.png" alt=""/>
                    <img className="h-[10rem] cursor-pointer" src="./Skin-care.png" alt=""/>
                </div>
            </article>
        <Products2/>
        <NewsComp/>
